...
export const metadata: Metadata = {
  ...
  description:
    "Quiniela del Mundial 2026 (también porra, prode, polla o pool) para amigos, equipos y empresas. Calendario completo, grupos, bracket FIFA, goleadores y predicciones colaborativas. Gratis hasta 20 miembros; planes para grupos grandes.",
  applicationName: appName,
  keywords: [
    // Marca y variaciones del torneo
    "Mundial 2026",
    "Copa Mundial 2026",
    "Copa Mundial de la FIFA 2026",
    "FIFA World Cup 2026",
    "Mundial USA Canadá México 2026",
    // Quiniela y sinónimos regionales — España, México, Argentina,
    // Uruguay, Colombia, Venezuela, USA hispano.
    "quiniela",
    "quiniela mundial",
