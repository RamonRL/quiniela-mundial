...
import { isGmailAddress } from "./gmail";
    ...
    <div className="space-y-6">
      ...
      {step === "email" ? (
        <form action={sendAction} className="space-y-3">
          ...
          >
            {sending ? t("sendingCode") : t("sendMeCode")}
          </Button>
        ...
        <form action={verifyAction} className="space-y-3">
          ...
          >
            <ArrowLeft className="size-3" /> {t("changeEmail")}
          </button>
        </form>
      )}
    </div>
