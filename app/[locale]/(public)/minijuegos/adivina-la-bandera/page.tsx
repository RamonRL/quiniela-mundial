...
import { AdivinaLaBanderaClient } from "./game-client";

const SLUG = "adivina-la-bandera";

export const metadata = {
  title: "Adivina la bandera · Minijuegos",
  description: "197 banderas del mundo, 60 segundos. ¿Cuántas conoces?",
};

export const revalidate = 30;

export default async function AdivinaLaBanderaPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <AdivinaLaBanderaClient myIdentityKey={myIdentityKey} myBestScore={myBest} />
