...
export const ANNEX_C_WINNER_COLUMNS = ["A","B","D","E","G","I","K","L"] as const;

export const ANNEX_C: Record<string, readonly [string, string, string, string, string, string, string, string]> = {
